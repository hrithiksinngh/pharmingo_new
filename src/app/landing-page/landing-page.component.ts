...
import { MarketAccessSectionComponent } from '../market-access-section/market-access-section.component';
import { ExplorePackagesSectionComponent } from '../explore-packages-section/explore-packages-section.component';
import { OfferingDetailsSectionComponent } from '../offering-details-section/offering-details-section.component';
...
@Component({
  ...
  imports: [
    ...
    MarketAccessSectionComponent,
    ExplorePackagesSectionComponent,
    OfferingDetailsSectionComponent,
...
export class LandingPageComponent {
  completedSteps: boolean[] = [false, false, false, false, false, false, false]; // Add a fake step
currentStep = 0;
  ...
  onWindowScroll(): void {
    // Check if the scroll position is 800px or more from the top
  ...
  startAnimation(): void {
    setInterval(() => {
      // Reset all steps when the fake step is reached
      if (this.currentStep === this.completedSteps.length - 1) {
        this.completedSteps.fill(false); // Reset all steps
        this.currentStep = 0; // Start from the first real step
      } else {
  ...
  offeringsCardData = [
    ...
    {
      title: 'Cost of Treatment data',
      tabTitle: 'Cost of Treatment',
